...
public class RestapiConfiguration {
	...
	CommandLineRunner initDatabaseAuto(AutoRepository autoRepository) {
		return args -> {
			LOG.info("Preloading " + autoRepository.save(new Auto("Auto 1", "blau")));
			LOG.info("Preloading " + autoRepository.save(new Auto("Auto 2", "blau")));
			LOG.info("Preloading " + autoRepository.save(new Auto("Auto 3", "blau")));
			LOG.info("Preloading " + autoRepository.save(new Auto("Auto 4", "blau")));
		};
	}
